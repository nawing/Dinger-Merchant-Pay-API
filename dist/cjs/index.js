...
exports.DingerPay = void 0;
const aes_ecb_1 = __importDefault(require("aes-ecb"));
...
class DingerPay {
    constructor(projectName, merchantName, apiKey, pubKey, cbkKey, environment) {
        ...
        this.verifyCb = async (opts) => {
            return JSON.parse(aes_ecb_1.default.decrypt(this.cbkKey, opts.paymentResult));
        };
